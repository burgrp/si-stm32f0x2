  ...
  namespace Flash {
    ...
    class Peripheral {
      ...
      /**
        Flash access control register
      */
      volatile Register::ACR ACR;
      /**
        Flash key register
      */
      volatile Register::KEYR KEYR;
      /**
        Flash option key register
      */
      volatile Register::OPTKEYR OPTKEYR;
      /**
        Flash status register
      */
      ...
      */
      ...
      /**
        Flash address register
      */
      volatile Register::AR AR;
      volatile char _space24[4];
      /**
        Option byte register
      */
      volatile Register::OBR OBR;
      /**
        Write protection register
      */
      volatile Register::WRPR WRPR;
    };
  }
}