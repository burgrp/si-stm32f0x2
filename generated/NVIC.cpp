  ...
  namespace NVIC {
    ...
    class Peripheral {
      ...
      /**
        Interrupt Set Enable Register
      */
      volatile Register::ISER ISER;
      volatile char _space4[124];
      /**
        Interrupt Clear Enable Register
      */
      volatile Register::ICER ICER;
      volatile char _space132[124];
      /**
        Interrupt Set-Pending Register
      */
      volatile Register::ISPR ISPR;
      volatile char _space260[124];
      /**
        Interrupt Clear-Pending Register
      */
      volatile Register::ICPR ICPR;
      volatile char _space388[380];
      /**
        Interrupt Priority Register 0
      */
      volatile Register::IPR0 IPR0;
      /**
        Interrupt Priority Register 1
      */
      volatile Register::IPR1 IPR1;
      /**
        Interrupt Priority Register 2
      */
      volatile Register::IPR2 IPR2;
      /**
        Interrupt Priority Register 3
      */
      volatile Register::IPR3 IPR3;
      /**
        Interrupt Priority Register 4
      */
      volatile Register::IPR4 IPR4;
      /**
        Interrupt Priority Register 5
      */
      volatile Register::IPR5 IPR5;
      /**
        Interrupt Priority Register 6
      */
      volatile Register::IPR6 IPR6;
      /**
        Interrupt Priority Register 7
      */
      volatile Register::IPR7 IPR7;
    };
  }
}