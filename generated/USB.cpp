  ...
  namespace USB {
    ...
    class Peripheral {
      ...
      /**
        endpoint 0 register
      */
      volatile Register::EP0R EP0R;
      /**
        endpoint 1 register
      */
      volatile Register::EP1R EP1R;
      /**
        endpoint 2 register
      */
      volatile Register::EP2R EP2R;
      /**
        endpoint 3 register
      */
      volatile Register::EP3R EP3R;
      /**
        endpoint 4 register
      */
      volatile Register::EP4R EP4R;
      /**
        endpoint 5 register
      */
      volatile Register::EP5R EP5R;
      /**
        endpoint 6 register
      */
      volatile Register::EP6R EP6R;
      /**
        endpoint 7 register
      */
      volatile Register::EP7R EP7R;
      volatile char _space32[32];
      /**
        control register
      */
      volatile Register::CNTR CNTR;
      /**
        interrupt status register
      */
      volatile Register::ISTR ISTR;
      /**
        frame number register
      */
      volatile Register::FNR FNR;
      /**
        device address
      */
      volatile Register::DADDR DADDR;
      /**
        Buffer table address
      */
      volatile Register::BTABLE BTABLE;
      /**
        LPM control and status register
      */
      volatile Register::LPMCSR LPMCSR;
      /**
        Battery charging detector
      */
      volatile Register::BCDR BCDR;
    };
  }
}