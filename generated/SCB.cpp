  ...
  namespace SCB {
    ...
    class Peripheral {
      ...
      /**
        CPUID base register
      */
      volatile Register::CPUID CPUID;
      /**
        Interrupt control and state register
      */
      volatile Register::ICSR ICSR;
      volatile char _space8[4];
      /**
        Application interrupt and reset control register
      */
      volatile Register::AIRCR AIRCR;
      /**
        System control register
      */
      volatile Register::SCR SCR;
      /**
        Configuration and control register
      */
      volatile Register::CCR CCR;
      volatile char _space24[4];
      /**
        System handler priority registers
      */
      volatile Register::SHPR2 SHPR2;
      /**
        System handler priority registers
      */
      volatile Register::SHPR3 SHPR3;
    };
  }
}