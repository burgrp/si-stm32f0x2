  ...
  namespace SYSCFG {
    ...
    class Peripheral {
      ...
      /**
        configuration register 1
      */
      volatile Register::SYSCFG_CFGR1 SYSCFG_CFGR1;
      volatile char _space4[4];
      /**
        external interrupt configuration register 1
      */
      volatile Register::SYSCFG_EXTICR1 SYSCFG_EXTICR1;
      /**
        external interrupt configuration register 2
      */
      volatile Register::SYSCFG_EXTICR2 SYSCFG_EXTICR2;
      /**
        external interrupt configuration register 3
      */
      volatile Register::SYSCFG_EXTICR3 SYSCFG_EXTICR3;
      /**
        external interrupt configuration register 4
      */
      volatile Register::SYSCFG_EXTICR4 SYSCFG_EXTICR4;
      /**
        configuration register 2
      */
      volatile Register::SYSCFG_CFGR2 SYSCFG_CFGR2;
      /**
        control and status register
      */
      volatile Register::COMP_CSR COMP_CSR;
    };
  }
}