  ...
  namespace GPIO_A {
    ...
    class Peripheral {
      ...
      /**
        GPIO port mode register
      */
      volatile Register::MODER MODER;
      /**
        GPIO port output type register
      */
      volatile Register::OTYPER OTYPER;
      /**
        GPIO port output speed register
      */
      volatile Register::OSPEEDR OSPEEDR;
      /**
        GPIO port pull-up/pull-down register
      */
      volatile Register::PUPDR PUPDR;
      /**
        GPIO port input data register
      */
      volatile Register::IDR IDR;
      /**
        GPIO port output data register
      */
      volatile Register::ODR ODR;
      /**
        GPIO port bit set/reset register
      */
      volatile Register::BSRR BSRR;
      /**
        GPIO port configuration lock register
      */
      volatile Register::LCKR LCKR;
      /**
        GPIO alternate function low register
      */
      volatile Register::AFRL AFRL;
      /**
        GPIO alternate function high register
      */
      volatile Register::AFRH AFRH;
      /**
        Port bit reset register
      */
      volatile Register::BRR BRR;
    };
  }
}