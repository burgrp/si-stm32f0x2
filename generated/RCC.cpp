    ...
    class Peripheral {
      ...
      */
      ...
      /**
        Clock interrupt register (RCC_CIR)
      */
      volatile Register::CIR CIR;
      /**
        APB2 peripheral reset register (RCC_APB2RSTR)
      */
      volatile Register::APB2RSTR APB2RSTR;
      /**
        APB1 peripheral reset register (RCC_APB1RSTR)
      */
      volatile Register::APB1RSTR APB1RSTR;
      /**
        AHB Peripheral Clock enable register (RCC_AHBENR)
      */
      volatile Register::AHBENR AHBENR;
      /**
        APB2 peripheral clock enable register (RCC_APB2ENR)
      */
      volatile Register::APB2ENR APB2ENR;
      /**
        APB1 peripheral clock enable register (RCC_APB1ENR)
      */
      volatile Register::APB1ENR APB1ENR;
      /**
        Backup domain control register (RCC_BDCR)
      */
      volatile Register::BDCR BDCR;
      /**
        Control/status register (RCC_CSR)
      */
      ...
      /**
        AHB peripheral reset register
      */
      volatile Register::AHBRSTR AHBRSTR;
      /**
        Clock configuration register 2
      */
      volatile Register::CFGR2 CFGR2;
      /**
        Clock configuration register 3
      */
      volatile Register::CFGR3 CFGR3;
      /**
        Clock control register 2
      */
